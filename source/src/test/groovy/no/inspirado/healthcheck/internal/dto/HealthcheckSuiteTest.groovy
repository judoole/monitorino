...
class HealthcheckSuiteTest {
    ...
    void should_be_able_to_represent_as_xml(){
        ...
        given_monitorsuite_has_case(new HealthcheckCase(name: "case1", failure: new HealthcheckStacktrace(message: "Things went far from good")));
        given_monitorsuite_has_case(new HealthcheckCase(name: "case 2", error: new HealthcheckStacktrace(message: "Things did not go so well no either", stacktrace: "Bla, bla, BLAM!")));
        given_monitorsuite_has_case(new HealthcheckCase(name: "case 3. The good case"));
        given_monitorsuite_has_property(new HealthcheckProperty(name:"Simple property", value:"Simple value"))
    ...
    void should_be_able_to_represent_as_html(){
        given_monitorsuite_has_name("My monitorsuite");
        given_monitorsuite_has_case(new HealthcheckCase(name: "case 1", failure: new HealthcheckStacktrace(message: "Things went far from good")));
        given_monitorsuite_has_case(new HealthcheckCase(name: "case 2", error: new HealthcheckStacktrace(message: "Things did not go so well no either", stacktrace: "Bla, bla, BLAM!")));
        given_monitorsuite_has_case(new HealthcheckCase(name: "case 3. The good case"));
        given_monitorsuite_has_property(new HealthcheckProperty(name:"Simple property", value:"Simple value"))
    ...
    void given_monitorsuite_has_case(HealthcheckCase monitorCase) {
        msg.addCase(monitorCase);
    }

    void given_monitorsuite_has_property(HealthcheckProperty monitorProperty) {
        msg.healthcheckProperties.add(monitorProperty);
    }
